...
public class OBJLoader {
        ...
        try{
            while(true){
                ...
                if (line.startsWith("v ")){
                    ...
                    Vector3f normal_vertex = new Vector3f(Float.parseFloat(currentLine[1]), Float.parseFloat(currentLine[2]), Float.parseFloat(currentLine[3]));
                    normals.add(normal_vertex);
    ...
    private static void processVertex(String[] vertexData, List<Integer> indices, List<Vector2f> textures, List<Vector3f> normals,
        ...
        int currentVertexDataPointer = Integer.parseInt(vertexData[0]) - 1;
        indices.add(currentVertexDataPointer);
